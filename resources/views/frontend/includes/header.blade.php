        ...
        <div class="ku-header-container-inner clearfix">
            <div class="ku-logo  ku-item-pdlr">
                <div class="ku-logo-inner">
                    <a class="" href="{{ route('home') }}"><img src=" {{ asset('frontend/images/logo.png') }} " alt="KU LOGO" /></a>
                </div>
            </div>
            <div class="ku-navigation ku-item-pdlr clearfix ">
                <div class="ku-main-menu" id="ku-main-menu">
                    <ul id="menu-main-navigation-1" class="sf-menu"  style="font-size:15px;">
                        <li class=" {{ Request::path() === 'home' ? 'menu-item menu-item-home current-menu-item menu-item-has-children ku-normal-menu' : '' }} "><a href="{{ route('home') }}" class="sf-with-ul-pre">Home</a></li>
                        ...
                        <li class="menu-item menu-item-has-children ku-mega-menu"><a href="#" class="sf-with-ul-pre">Academics</a>
                            <div class="sf-mega sf-mega-full megaimg">
                                <ul class="sub-menu">
                                    <li class="menu-item menu-item-has-children" data-size="15"><a class="sf-with-ul-pre">Undergraduate</a>
                                        <ul class="sub-menu">
                                            <li class=" {{ Request::path() === 'home' ? 'menu-item current-menu-item ' : '' }}"><a href="{{ route('business-administration') }}" target="_blank">Business Administration</a></li>
                                    ...
                                    <li class="menu-item menu-item-has-children" data-size="15"><a href="#" class="sf-with-ul-pre">Resources</a>
                                        <ul class="sub-menu">
                                            <li class="menu-item"><a href="{{ asset('frontend/pdf/almanac.pdf') }}" target="_blank">Kampala University Almac 2020</a></li>
                                            <li class="menu-item"><a href="{{ asset('frontend/pdf/courses.pdf') }}" target="_blank">Our Courses</a></li>
                                            <li class="menu-item"><a href="{{ asset('frontend/pdf/Graduate_application.pdf') }}" target="_blank">Graduate Application</a></li>
                                            <li class="menu-item"><a href="{{ asset('Application_Undergraduate.pdf') }}" target="_blank">Undergraduate Application</a></li>
                                            <li class="menu-item"><a href="{{ asset('frontend/pdf/STUDENTS-LOAN-APPLICATION-FORM-2019_20.pdf') }}" target="_blank">HESFB Loan Form</a></li>
                                            <li class="menu-item"><a href="{{ asset('frontend/pdf/GENERAL-CIRCULAR-FEB_MAY-2019.pdf') }}" target="_blank">General Circular 2018/2019</a></li>
                                            <li class="menu-item"><a href="{{ asset('frontend/pdf/Aug-Dec-Semester-Sports-Activities.pdf') }}" target="_blank">August December Sports Activities</a></li>
                                            <li class="menu-item"><a href="{{ asset('frontend/pdf/LIST-OF-GRADUANDS-2019.pdf') }} " target="_blank">2019 Graduation List</a></li>
                                        </ul>
                                    </li>
                                    ...
                                    <li class="menu-item" data-size="15">
                                        <div class="ku-mega-menu-section-content"><img src=" {{ asset('frontend/images/eagle-clear-ku-logo-dark.png') }} " id="img_fd84_0" alt="" /> <span id="span_fd84_0">Academic offerings include 95 majors, 86 minors, and more than 100 in-major specializations</span></div>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        ...
                        <li class="menu-item menu-item-has-children ku-normal-menu"><a href="#" class="sf-with-ul-pre">Research</a>
                            <ul class="sub-menu">
                                ...
                                <li class="menu-item" data-size="60">
                                    <a href=" {{ asset('frontend/pdf/KAMPALA_UNIVERSITY_RESEARCH_JOURNAL2019.pdf') }} " target="_blank">Publication</a>
                                </li>
                            </ul>
                        </li>
